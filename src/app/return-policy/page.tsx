    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white gradient-bg flex flex-col justify-between">
      ...
      <main className="container mx-auto px-6 pt-32 pb-20 flex-grow max-w-4xl">
        ...
        <div className="mb-12 border-b border-zinc-800 pb-8">
          <span className="text-xs font-mono tracking-widest neon-purple block mb-2 uppercase">
        ...
        <div className="bg-rose-950/20 border border-rose-500/30 rounded-2xl p-6 md:p-8 mb-8 shadow-[0_0_30px_rgba(239,68,68,0.05)] backdrop-blur-md">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 rounded-lg bg-rose-500/10 flex items-center justify-center border border-rose-500/30 text-rose-400 shrink-0">
              <i className="fas fa-exclamation-triangle text-lg"></i>
            </div>
            <div>
              <h2 className="text-lg font-bold orbitron text-rose-400 mb-2 uppercase tracking-wide">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-zinc-950/80 border border-zinc-800/80 rounded-2xl p-6 md:p-8 shadow-2xl backdrop-blur-md">
            ...
            <div className="bg-zinc-900/60 rounded-xl border border-zinc-800/60 p-4 font-mono text-xs text-zinc-400 space-y-2">
          ...
          <div className="border border-zinc-800/80 rounded-2xl p-6 md:p-8 bg-zinc-950/20">
            <h4 className="text-sm font-bold orbitron text-zinc-300 mb-6 uppercase tracking-wider">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center font-mono">
              <div className="flex flex-col items-center">
                ...
                <p className="text-[11px] text-zinc-500">Capture continuous video from seal-break to defect identification.</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-[11px] text-zinc-500">Email support with your order number, video link, and photos within 7 days.</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-[11px] text-zinc-500">Once verified, a brand new replacement is pushed directly to production.</p>
              </div>
            </div>
          </div>
        </div>
