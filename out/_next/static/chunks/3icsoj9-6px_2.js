(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,19172,e=>{"use strict";var s=e.i(43476),t=e.i(71645),a=e.i(32341);e.i(47167);var i=e.i(41402),r=e.i(17255);let n=()=>{let{login:e,signup:n}=(0,a.useAuth)(),{showNotification:l}=(0,i.useNotification)();(0,t.useEffect)(()=>{{let e=setInterval(()=>{if(window.google?.accounts?.id){clearInterval(e);let s=window.google;s.accounts.id.initialize({client_id:"555849725616-cfsnu89kf426p6c2fj476vhfqg1o5i7k.apps.googleusercontent.com",callback:e=>{try{let s=e.credential.split(".")[1].replace(/-/g,"+").replace(/_/g,"/"),t=decodeURIComponent(atob(s).split("").map(e=>"%"+("00"+e.charCodeAt(0).toString(16)).slice(-2)).join("")),a=JSON.parse(t),i=a.given_name||a.name?.split(" ")[0]||"Google",r=a.family_name||a.name?.split(" ")[1]||"User",n={firstName:i,lastName:r,displayName:a.name||`${i} ${r}`,email:a.email,memberSince:new Date().getFullYear().toString(),avatarInitials:(i.substring(0,1)+r.substring(0,1)).toUpperCase()};localStorage.setItem("ub_user",JSON.stringify(n)),l(`Signed in as ${a.email}!`),window.location.reload()}catch(e){console.error("JWT Decode error",e),w("Failed to process Google login response.")}}});let t=document.getElementById("google-signin-btn-div");t&&s.accounts.id.renderButton(t,{theme:"filled_blue",size:"large",text:"signin_with",shape:"rectangular",width:t.clientWidth||300})}},500);return()=>clearInterval(e)}},[!0]);let[d,o]=(0,t.useState)(!0),[c,h]=(0,t.useState)(""),[u,p]=(0,t.useState)(""),[m,x]=(0,t.useState)(""),[g,b]=(0,t.useState)(""),[j,f]=(0,t.useState)(""),[v,N]=(0,t.useState)(!1),[y,w]=(0,t.useState)(""),k=async s=>{if(s.preventDefault(),console.log("Credentials Triggered"),!c||!u)return void w("Please fill in all fields.");w(""),N(!0);try{let s=await (0,r.signIn)("credentials",{email:c,password:u,redirect:!1});s?.error?w(s.error||"Authentication failed."):(await e(c,u),l("Signed in successfully!"))}catch(e){w("An unexpected error occurred.")}finally{N(!1)}},C=async e=>{if(e.preventDefault(),!c||!u||!g||!j)return void w("Please fill in all fields.");if(u!==m)return void w("Passwords do not match.");if(u.length<6)return void w("Password must be at least 6 characters.");w(""),N(!0);try{let e=await n(c,u,g,j);e.success?l("Account created successfully!"):w(e.error||"Registration failed.")}catch(e){w("An unexpected error occurred.")}finally{N(!1)}};return(0,s.jsxs)("div",{className:"auth-gate-page",children:[(0,s.jsx)("style",{dangerouslySetInnerHTML:{__html:`
        .auth-gate-page {
          --bg: #0a0a0a;
